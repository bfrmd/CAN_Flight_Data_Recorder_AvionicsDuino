...
void append_page_header() {
  ...
  webpage += F("<head>");
  webpage += F("<title>MC Server</title>"); // NOTE: 1 em = 16px
  ...
  webpage += F("ul{list-style-type:none;padding:0;border-radius:0em;overflow:hidden;background-color:#0000FF;font-size:1.5em;}");
  ...
  webpage += F("</style></head><body><h1>ESP32 file server</h1>");
  webpage += F("<ul>");
  webpage += F("<li><a href='/'>Download</a></li>"); //Menu bar with commands
